	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			if (attack.equals("yell")) {
				...
				int dragonDamage = r.nextInt(26);

				// -- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - dragonDamage;

				// 11. Find a random number between 0 and 35 and store it in playerDamage
				int playerDamage = r.nextInt(36);
			...
			if (playerHealth <= 0) {
				...
				System.out.println("The dragon is dead and you won the gold!");
				// 15. Else
			} else {
				System.out.println("Players Health: " + playerHealth);
				...
				System.out.println("Dragons Health: " + dragonHealth);
			}
		}
	}
}
