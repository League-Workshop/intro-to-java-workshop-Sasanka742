...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String bpart = JOptionPane.showInputDialog("Enter a body part: ");
		...
		String sent = JOptionPane.showMessageDialog(null,
				"Piranhas are more " + adj
						+ " during the day, \n so cross the river at night. Piranhas are attracted to fresh " + liq
						+ "and will most likely take a bite out of your " + bpart + "if you" + verb
